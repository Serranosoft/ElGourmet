...
public class RecetasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.recetasfragment, container, false);
        ...
        getData();
        /*adapter = new RecetasAdapter(recetaLista, getContext(), new RecetasAdapter.OnItemClickListener() {
            @Override
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i = 0; i < jsonArray.length() ; i++){
                                ...
                                Receta r2 = new Receta(imagenUrl, nombreReceta, elaboracion, ingredientes);
                                Receta r = new Receta(imagenUrl, nombreReceta);
                                Receta r3 = new Receta(imagenUrl, nombreReceta, elaboracion);
                                recetaLista.add(r2);
